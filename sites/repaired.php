...
<head>
	...
	<title>Mark Chromebook as Repaired | SnipeTools</title>
	<link rel = "stylesheet" href = "style.css">
</head>
<body>
	<?php echo $audioMessage; ?>
	<div id = "page">
	<h1>Mark Chromebook as Repaired</h1>

	<form action="../api_requests/repairedAPI.php" method="GET" autocomplete="on">
		<label for="serial">Scan Serial #</label>
		<input type="hidden" name="source" value="repaired">
