...
<head>
	...
	<title>Return Broken Chromebooks to Office | SnipeTools</title>
	<link rel = "stylesheet" href = "style.css">
</head>
<body>
	<?php echo $audioMessage; ?>
	<div id = "page">
	<h1>Return Broken Chromebooks to Office</h1>

	<form action="../api_requests/brokenToOfficeAPI.php" method="GET" autocomplete="on">
		<label for="serial">Scan Serial #</label>
		<input type="hidden" name="source" value="brokenToOffice">
