...
echo "<style> #page {background-color: #337ab7; color: white;} body {background-color: #337ab7; color: white;} </style>";
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' and isset($_GET['SnipeRequestStatus'])) {
	...
	if($_GET['SnipeRequestStatus'] == -1) {
		...
		echo "<style> #page {background-color: red; color: black;} body {background-color: red; color: black;} </style>";
		...
		//set a pretty background color
		echo "<style> #page {background-color: green; color: black;} body {background-color: green; color: black;} </style>";
	...
	if($_SERVER['REQUEST_METHOD'] === 'GET' and isset($_GET['GoogleRequestStatus'])) {
		...
		if($_GET['SnipeRequestStatus'] >= 1 && $_GET['GoogleRequestStatus'] <= -1){
			echo "<style> #page {background-color: yellow; color: black;} body {background-color: yellow; color: black;} </style>";
		}
